module github.com/guidomantilla/yarumo/diagnostics/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/diagnostics => ../
...
require (
	...
	github.com/guidomantilla/yarumo/diagnostics v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/guidomantilla/yarumo/extensions/log v0.0.0-00010101000000-000000000000 // indirect
