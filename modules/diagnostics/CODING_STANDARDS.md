# Coding Standards — modules/diagnostics/
...
module lives at the top-level module layer alongside `modules/cron/`,
`modules/grpc/`, `modules/http/`, `modules/managed/`, `modules/cache/`,
`modules/telemetry/` and `modules/config/`.
