module github.com/guidomantilla/yarumo/http/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/http => ../
...
require (
	...
	github.com/guidomantilla/yarumo/http v0.0.0-00010101000000-000000000000
)
