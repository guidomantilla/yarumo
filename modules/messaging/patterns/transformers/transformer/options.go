...
// Option is a functional option for configuring transformer Options.
// Transformer has no T-typed or U-typed options, so Option is
// non-generic — matching bridge/filter and diverging from
// router/Option[T] is intentional and keeps the callsite simpler.
type Option func(opts *Options)

// Options holds the configuration for a Transformer.
type Options struct {
...
// transformer failure (TransformFn returned error, TransformFn panicked,
