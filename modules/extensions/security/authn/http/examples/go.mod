module github.com/guidomantilla/yarumo/extensions/security/authn/http/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extensions/security/authn/http => ../
...
require (
	...
	github.com/guidomantilla/yarumo/extensions/security/authn/http v0.0.0-00010101000000-000000000000
