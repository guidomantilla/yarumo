...
import (
	...
	otelhttp "github.com/guidomantilla/yarumo/extensions/telemetry/otel/http"
)
...
func run() error {
	name, version, env := "modules/extensions/telemetry/otel/http/examples/main.go", "1.0", "examples"
