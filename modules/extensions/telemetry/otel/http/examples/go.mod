module github.com/guidomantilla/yarumo/extensions/telemetry/otel/http/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extensions/telemetry/otel/http => ../

replace github.com/guidomantilla/yarumo/common => ../../../../../common

replace github.com/guidomantilla/yarumo/config => ../../../../../config

replace github.com/guidomantilla/yarumo/extensions/common/log/slog => ../../../../common/log/slog

require (
	github.com/guidomantilla/yarumo/config v0.0.0-00010101000000-000000000000
	github.com/guidomantilla/yarumo/extensions/telemetry/otel/http v0.0.0-00010101000000-000000000000
