...
import (
	...
	otelslog "github.com/guidomantilla/yarumo/extensions/telemetry/otel/slog"
)
...
func run() error {
	name, version, env := "modules/extensions/telemetry/otel/slog/examples/main.go", "1.0", "examples"
