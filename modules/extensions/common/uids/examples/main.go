// Demo that exercises the public API of the extensions/common/uids
// package:
//
...
import (
	...
	uids "github.com/guidomantilla/yarumo/extensions/common/uids"
)
...
func run() error {
	name, version, env := "modules/extensions/common/uids/examples/main.go", "1.0", "examples"
...
// registry populated by extensions/common/uids' init().
