# Coding Standards — modules/extensions/common/resilience/retry/
...
Earlier `extensions/common/resilience/` shipped registries and used the
...
### Override: Sibling to `extensions/common/http/retry/`

`extensions/common/http/retry/` wraps an `http.RoundTripper` with retry
