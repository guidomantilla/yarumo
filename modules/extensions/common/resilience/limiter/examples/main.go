...
import (
	...
	"github.com/guidomantilla/yarumo/extensions/common/resilience/limiter"
)
...
func run() error {
	name, version, env := "modules/extensions/common/resilience/limiter/examples/main.go", "1.0", "examples"
