module github.com/guidomantilla/yarumo/extensions/common/resilience/limiter/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extensions/common/resilience/limiter => ../
