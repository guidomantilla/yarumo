...
import (
	...
	"github.com/guidomantilla/yarumo/extensions/common/resilience/breaker"
)
...
func run() error {
	name, version, env := "modules/extensions/common/resilience/breaker/examples/main.go", "1.0", "examples"
