# Coding Standards — modules/extensions/common/log/zerolog/
...
### Override: Sibling impl to `extensions/common/log/slog/`
...
(`extensions/common/resilience/{breaker,limiter,retry}`), this module
