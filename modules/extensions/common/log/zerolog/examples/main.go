// Demo that exercises the public API of the extensions/common/log/zerolog
// package:
//
...
import (
	...
	czerolog "github.com/guidomantilla/yarumo/extensions/common/log/zerolog"
...
func run() error {
	name, version, env := "modules/extensions/common/log/zerolog/examples/main.go", "1.0", "examples"
