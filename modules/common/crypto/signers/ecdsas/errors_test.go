...
func TestError_Error(t *testing.T) {
	...
	t.Run("formats error with type and cause", func(t *testing.T) {
		...
		if !strings.Contains(got, "ecdsa") {
			t.Fatalf("expected 'ecdsa' in error, got %q", got)
		}
	})
}
...
func TestErrSigning(t *testing.T) {
	...
	t.Run("wraps with ErrSigningFailed sentinel", func(t *testing.T) {
		t.Parallel()
...
func TestErrVerification(t *testing.T) {
	...
	t.Run("wraps with ErrVerificationFailed sentinel", func(t *testing.T) {
		t.Parallel()
