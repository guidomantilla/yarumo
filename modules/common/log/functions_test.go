...
//
// The subpackages (modules/log/slog and modules/log/slog/slogctx) own
// no global state and their tests run with t.Parallel() on every test
// and subtest. Tracked in #168 (MAJOR_DRIFT root-package parallelism).
