# Coding Standards — `modules/crypto`

The crypto module follows the **general review criteria** from
`modules/common/CODING_STANDARDS.md` (criteria 1–9 + "No Inline Assignments"
...
The 3 utility subpackages follow the general repo standards (`modules/common/CODING_STANDARDS.md`)
