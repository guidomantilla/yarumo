module github.com/guidomantilla/yarumo/managed/keep-alive/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/managed/keep-alive => ../
...
require (
	...
	github.com/guidomantilla/yarumo/managed/keep-alive v0.0.0-00010101000000-000000000000
)
