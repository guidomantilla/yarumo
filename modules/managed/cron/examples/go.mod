module github.com/guidomantilla/yarumo/managed/cron/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/managed/cron => ../
...
require (
	...
	github.com/guidomantilla/yarumo/managed/cron v0.0.0-00010101000000-000000000000
)
