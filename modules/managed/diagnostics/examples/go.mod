module github.com/guidomantilla/yarumo/managed/diagnostics/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/managed/diagnostics => ../
...
require (
	...
	github.com/guidomantilla/yarumo/managed/diagnostics v0.0.0-00010101000000-000000000000
)
