module github.com/guidomantilla/yarumo/managed/http/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/managed/http => ../
...
require (
	...
	github.com/guidomantilla/yarumo/managed/http v0.0.0-00010101000000-000000000000
)
