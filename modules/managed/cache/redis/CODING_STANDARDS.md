# Coding Standards — modules/managed/cache/redis/
...
`modules/managed/cache/ristretto/`, `modules/managed/cron/`,
...
The ristretto backend lives in `modules/managed/cache/ristretto/`. Sibling
