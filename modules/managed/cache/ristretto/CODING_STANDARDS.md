# Coding Standards — modules/managed/cache/ristretto/
...
at the top-level module layer alongside `modules/managed/cache/redis/`,
`modules/managed/cron/`, `modules/managed/grpc/`, `modules/managed/http/`,
`modules/managed/diagnostics/`, `modules/managed/keep-alive/` and
`modules/managed/telemetry/`, never inside `modules/common/`.
...
The redis backend lives in `modules/managed/cache/redis/`. Sibling
...
`modules/common/cache/`; the 5-sentinel error vocabulary is duplicated
