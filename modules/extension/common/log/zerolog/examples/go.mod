module github.com/guidomantilla/yarumo/extension/common/log/zerolog/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extension/common/log/zerolog => ../

replace github.com/guidomantilla/yarumo/common => ../../../../../common

replace github.com/guidomantilla/yarumo/config => ../../../../../config

replace github.com/guidomantilla/yarumo/extension/common/log/slog => ../../slog

require (
	github.com/guidomantilla/yarumo/config v0.0.0-00010101000000-000000000000
	github.com/guidomantilla/yarumo/extension/common/log/zerolog v0.0.0-00010101000000-000000000000
)
