module github.com/guidomantilla/yarumo/extension/common/http/retry/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extension/common/http/retry => ..
...
require (
	...
	github.com/guidomantilla/yarumo/extension/common/http/retry v0.0.0-00010101000000-000000000000
