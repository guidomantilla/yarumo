# Coding Standards — modules/extension/common/http/breaker/
...
### Override: Sibling to `extension/common/http/{limiter,retry}/`
...
`extension/common/resilience/{breaker,limiter,retry}/` and these modules
