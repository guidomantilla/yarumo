module github.com/guidomantilla/yarumo/extension/common/cast/examples

go 1.25.5

replace github.com/guidomantilla/yarumo/extension/common/cast => ..
...
require (
	...
	github.com/guidomantilla/yarumo/extension/common/cast v0.0.0-00010101000000-000000000000
)
