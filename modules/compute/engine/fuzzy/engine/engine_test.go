...
func makeTemperatureInput() variable.Variable {
	cold, _ := fuzzym.Triangular(0, 0, 50)
	warm, _ := fuzzym.Triangular(20, 50, 80)
	hot, _ := fuzzym.Triangular(50, 100, 100)
...
func makeSpeedOutput() variable.Variable {
	slow, _ := fuzzym.Triangular(0, 0, 50)
	medium, _ := fuzzym.Triangular(20, 50, 80)
	fast, _ := fuzzym.Triangular(50, 100, 100)
...
func TestEngine_Infer_mamdani_multipleConditions_and(t *testing.T) {
	...
	low, _ := fuzzym.Triangular(0, 0, 50)
	high, _ := fuzzym.Triangular(50, 100, 100)
