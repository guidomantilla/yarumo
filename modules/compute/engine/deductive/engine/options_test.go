...
func TestNewOptions(t *testing.T) {
	...
	t.Run("defaults", func(t *testing.T) {
		...
		if opts.maxDepth != defaultMaxDepth {
			t.Fatalf("expected %d, got %d", defaultMaxDepth, opts.maxDepth)
		}
...
func TestWithMaxDepth(t *testing.T) {
	...
	t.Run("positive value", func(t *testing.T) {
		...
		opts := NewOptions(WithMaxDepth(50))
		if opts.maxDepth != 50 {
			t.Fatalf("expected 50, got %d", opts.maxDepth)
		}
	})
	...
	t.Run("zero ignored", func(t *testing.T) {
		...
		opts := NewOptions(WithMaxDepth(0))
		if opts.maxDepth != defaultMaxDepth {
			t.Fatalf("expected default %d, got %d", defaultMaxDepth, opts.maxDepth)
		}
	})
	...
	t.Run("negative ignored", func(t *testing.T) {
		...
		opts := NewOptions(WithMaxDepth(-5))
		if opts.maxDepth != defaultMaxDepth {
			t.Fatalf("expected default %d, got %d", defaultMaxDepth, opts.maxDepth)
		}
	})
