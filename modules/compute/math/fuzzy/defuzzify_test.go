...
func TestDefuzzify_mismatchedLengths(t *testing.T) {
	t.Parallel()
	...
	t.Run("MeanOfMax", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("LargestOfMax", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("SmallestOfMax", func(t *testing.T) {
		t.Parallel()
