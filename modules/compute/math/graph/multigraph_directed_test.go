...
func TestNewMultigraphDirected(t *testing.T) {
	t.Parallel()

	m := NewMultigraphDirected()
	if m.NodeCount() != 0 {
		t.Fatalf("expected 0 nodes, got %d", m.NodeCount())
	}
}

func TestMultigraphDirected_parallel_edges(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_EdgesBetween(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_EdgesBetween_not_found(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_Directed(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_Clone(t *testing.T) {
	t.Parallel()
	...
	clone := m.CloneMultigraphDirected()
	_ = m.AddNode(Node{ID: "C"})
...
func TestMultigraphDirected_Clone_interface(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_delegated_methods(t *testing.T) {
	t.Parallel()
...
func TestMultigraphDirected_self_loop(t *testing.T) {
	t.Parallel()
