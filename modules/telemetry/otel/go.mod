module github.com/guidomantilla/yarumo/telemetry/otel
...
replace github.com/guidomantilla/yarumo/http => ../../http
...
require (
	...
	github.com/guidomantilla/yarumo/http v0.0.0-00010101000000-000000000000 // indirect
