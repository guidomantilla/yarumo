...
var User = UserType{Name: "Ana", Age: 22, Active: true, Email: "", Country: "CO", IsAdmin: true, Has2FA: false, TermsAccepted: false}

var Adult = propositions.Var("Adult")
var Active = propositions.Var("Active")
var Colombian = propositions.Var("Colombian")
var EmailValid = propositions.Var("EmailValid")
var Has2FA = propositions.Var("Has2FA")
var TermsAccepted = propositions.Var("TermsAccepted")
var Admin = propositions.Var("Admin")

var Predicates = map[propositions.Var]predicates.Predicate[UserType]{
...
var UserRules = []rules.Rule[UserType]{
	{
