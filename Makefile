...
MODULES += modules/extensions/common/cast modules/extensions/common/log modules/extensions/common/resilience modules/extensions/common/uids modules/extensions/common/validation modules/extensions/telemetry/otel/slog
